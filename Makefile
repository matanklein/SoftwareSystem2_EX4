...
CXXFLAGS      = -pipe -std=c++2a -g -O2 -Wall -Wextra -D_REENTRANT -fPIC $(DEFINES)
...
COMPRESS      = gzip -9f
DISTNAME      = main1.0.0
DISTDIR = /home/matan/Desktop/CPP_EX4/.tmp/main1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
DIST          = /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		TreeGUI.pro node.hpp \
		tree.hpp \
		CustomEllipseItem.hpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents node.hpp tree.hpp CustomEllipseItem.hpp complex.hpp $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp CustomEllipseItem.cpp complex.cpp $(DISTDIR)/
...
moc_predefs.h: /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/data/dummy.cpp
	g++ -pipe -std=c++2a -g -O2 -Wall -Wextra -dM -E -o moc_predefs.h /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/data/dummy.cpp
...
main.o: main.cpp node.hpp \
		tree.hpp \
		iterators_on_tree.hpp \
		complex.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

CustomEllipseItem.o: CustomEllipseItem.cpp CustomEllipseItem.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o CustomEllipseItem.o CustomEllipseItem.cpp
